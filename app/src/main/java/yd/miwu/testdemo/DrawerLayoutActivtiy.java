...
public class DrawerLayoutActivtiy extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer_layout_activtiy);
...
//            点击fab弹出上面两个FAB，通过FAB_STATE判断当前fab的打开状态
            ...
            case R.id.fab_favorite:
                ...
                Snackbar.make(parentLayout,"你点击了FAB_FAVORITE",Snackbar.LENGTH_LONG)
                        ...
                        }).setActionTextColor(getResources().getColor(R.color.actionbar_bg))
                        .show();
                break;
        }
    }
