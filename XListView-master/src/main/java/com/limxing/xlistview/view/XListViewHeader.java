...
public class XListViewHeader extends LinearLayout {
    ...
    public final static int STATE_READY = 1; // 准备刷新状态，也就是箭头方向发生改变之后的状态
    public final static int STATE_REFRESHING = 2;// // 刷新状态，箭头变成了progressBar
    public final static int STATE_SUCCESS = 3;//刷新完成（处于刷新完成状态）
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                if (mState == STATE_READY) {
                    mArrowImageView.startAnimation(mRotateDownAnim);//箭头向下转
                }
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    mArrowImageView.clearAnimation();
                    mArrowImageView.startAnimation(mRotateUpAnim);//箭头向上转
